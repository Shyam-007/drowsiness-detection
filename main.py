...
#    playsound(r"F:\Shyam\1.python project\my proj\drowssiness detection\alarm.wav")
 ...
 #   t1.start()
    playsound(r"F:\Shyam\python_project\drowssiness_detection\external sources\alarm.wav")
...
predictor = dlib.shape_predictor(r"F:\Shyam\python_project\drowssiness_detection\external sources\shape_predictor_68_face_landmarks.dat")#help to plot all the coorinates
